  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('input', { type: 'url', id: 'Szervercím', ref: 'url', value: this.props.url }),
        React.createElement('input', { type: 'text', placeholder: 'Felhasználónév', id: 'username', ref: 'username', onKeyDown: this.onKeyDown, autofocus: true })
      )
    );
  }
}
